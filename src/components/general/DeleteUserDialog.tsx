...
const DeleteTraineeDialog: React.FC<DeleteTraineeDialogProps> = ({
  userId,
  traineeName,
  traineeClass,
  variant = "desktop",
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Confirmer la suppression du stagiaire</AlertDialogTitle>
          <AlertDialogDescription>
            Êtes-vous sûr de vouloir supprimer le stagiaire{" "}
            <span className="font-semibold">{traineeName}</span> de la classe{" "}
            <span className="font-semibold">{traineeClass}</span> ?
            <br />
            <br />
            <strong>Cette action est irréversible</strong> et supprimera toutes ses données (profil, réponses, scores).
          </AlertDialogDescription>
        </AlertDialogHeader>
